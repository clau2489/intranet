  ...
  <body class="login-page bg-login">
    <div class="login-box">
      <div style="color:#3c8dbc" class="login-logo">
        <img style="margin-top:-12px" src="assets/img/mmp.png" alt="Logo" height="50">
      </div><!-- /.login-logo -->
      <?php  
      ...
      <div class="login-box-body">
        ...
        <br>
        <hr>
        <b>Si no recuerda su contraseña o todavia no cuenta con un nombre de usuario registrado, por favor contáctese con el departamento de sistemas del Municipio de Marcos Paz.</b>
