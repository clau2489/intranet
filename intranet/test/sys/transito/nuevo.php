    ...
    <div class="row mt-2">
      <div class="col-md-4 offset-md-4 p-2">
        <div class="formulario">
          <h5>Ingreso de Nuevo Articulo</h5>
          <hr>
          <br>      
          <form action="procesos/agregar.php" method="post">                    
            <div class="form-row">
                <label>Código del Árticulo</label>
                <input type="text" class="form-control" id="dato_uno" name="dato_uno" placeholder="Código"  onkeyup="javascript:this.value=this.value.toUpperCase();" required>
            </div>
            <div class="form-row">
                <label>Descripción del Árticulo:</label>
                <input type="text" class="form-control" name="dato_dos" id="dato_dos" placeholder="Descripción" required onkeyup="javascript:this.value=this.value.toUpperCase();">        
            </div>                          
            <div class="form-row">
                <label>Precio de Compra</label>
                <input type="number" class="form-control monto" name="dato_tres" id="dato_tres" step="any" placeholder="0,00" required onkeyup="sumar();">
            </div>
            <div class="form-row">
              <div class="col-md-6">
                <label>Porcentaje aplicado:</label>
                <input type="number" class="form-control" name="dato_cuatro" id="dato_cuatro" step="any" placeholder="0,00" required onkeyup="sumar();">                
              </div>
              <div class="col-md-6">
                <label>Ganancia:</label>
                <input class="form-control monto" name="dato_cinco" id="dato_cinco" value="" required>               
              </div>
            </div>
            <div class="form-row">
                <label>Precio Final</label>
                <input class="form-control monto" name="dato_seis" id="dato_seis" value="" required>
                <br>
            </div>                        
            <br>
            <div class="form-row">
              <button type="submit" class="btn btn-success btn-block">Ingresar Artículo</button>
            </div>            
          </form>          
        </div>
