...
if ($_SESSION['permisos_acceso']=='Super Admin') { ?>
  <ul class="sidebar-menu">
    ...
    <li class="<?php echo $active_home;?>">
      <a href="?module=superadmin"><i class="fa fa-home"></i> Panel de Aplicaciones </a>
    </li>    
    <li class="<?php echo $active_home;?>">
...
elseif ($_SESSION['permisos_acceso']=='Gerente') { ?>
  ...
  <ul class="sidebar-menu">
    ...
    if ($_GET["module"]=="start") { ?>
      <li class="active">
        <a href="?module=start"><i class="fa fa-home"></i> Aplicaciones Disponibles </a>
      </li>
      <?php
    }
    else { ?>
...
//Permisos para Usuario con restricciones
if ($_SESSION['permisos_acceso']=='Almacen') { ?>
  <ul class="sidebar-menu">
    ...
    if ($_GET["module"]=="admin") { ?>
      <li class="<?php echo $active_home;?>">
        <a href="?module=admin"><i class="fa fa-home"></i>Panel de Aplicaciones </a>
      </li>
      <?php
    }
    else { ?>
