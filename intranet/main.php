    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <nav class="navbar navbar-static-top" role="navigation">
          ...
          <img src="assets/img/mmp.png" style="width: 100px; margin-left: 50px">
      ...
      <footer class="main-footer">
        <strong>Copyright &copy; <?php echo date('Y');?> - <a href="http://obedalvarado.pw/" target="_blank">Marcos Paz Digital</a></strong>
      </footer>
    </div><!-- ./wrapper -->
